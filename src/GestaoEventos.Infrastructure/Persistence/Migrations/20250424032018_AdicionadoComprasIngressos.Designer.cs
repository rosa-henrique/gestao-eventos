...
namespace GestaoEventos.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250424032018_AdicionadoComprasIngressos")]
    partial class AdicionadoComprasIngressos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoEventos.Domain.Compras.CompraIngresso", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("compra_ingresso", (string)null);
                });
            ...
            modelBuilder.Entity("GestaoEventos.Domain.Compras.CompraIngresso", b =>
                {
                    b.OwnsMany("GestaoEventos.Domain.Compras.IngressoComprado", "Ingressos", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<Guid>("compra_ingresso_id")
                                .HasColumnType("uuid");

                            b1.HasKey("Id");

                            b1.HasIndex("compra_ingresso_id");

                            b1.ToTable("compra_ingresso_ingressos", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("compra_ingresso_id");
                        });
